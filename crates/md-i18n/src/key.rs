...
i18n_keys! {
    ...
    SetBodyFontHint         "Markdown 正文使用的字族"
                            "Family for Markdown body text"
    SetCodeFont             "代码字体"          "Code font"
    SetCodeFontHint         "行内代码与代码块使用的字族，默认等宽"
                            "Family for inline code and code blocks; monospace by default"
    SetFontSystemDefault    "系统默认"          "System default"
    ...
    SetLineBreak            "换行方式"          "Line wrapping"
    SetLineBreakHint        "每一行断在哪里，行末要不要对齐"
                            "Where lines break and how they end"
    SetLineBreakGreedy      "逐行填满"          "Line by line"
    SetLineBreakOptimal     "整段调整"          "Whole paragraph"
    SetLineBreakJustify     "两端对齐"          "Justified"
    SetColors               "配色"              "Colors"
