...
i18n_keys! {
    ...
    SetLineBreak            "换行"              "Line breaking"
    SetLineBreakHint        "段落按行贪心排，还是整段寻优"
                            "Break each line greedily, or optimize the whole paragraph"
    SetLineBreakGreedy      "逐行"              "Fast"
    SetLineBreakOptimal     "最优"              "Optimal"
